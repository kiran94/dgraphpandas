...
python -m dgraphpandas -c $CONFIG -ck director -f $INPUT_DIR/directors.csv -o $OUTPUT_DIR
python -m dgraphpandas -c $CONFIG -ck title -f $INPUT_DIR/netflix_titles.csv -o $OUTPUT_DIR
